  ...
  return (
    <section>
      ...
      <div className="center-div">
        {noResult && valid ? (
          <div className="warning">...no crew found by that name...</div>
        ) : null}
        {!valid ? (
          <div className="warning">...please select a search option...</div>
        ) : null}
        <button className="submit-button" onClick={showAllCrew}>
          Show All Crew
        </button>
      </div>
