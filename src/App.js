  ...
  return (
    <div className="app">
      <BrowserRouter> 
          <Header />
          <Routes>
            <Route path="/" element={<Homepage crewData={crewData} updateCrewLike={updateCrewLike} companyData={companyData} />} />
            <Route path="crew" element={<Crew crewData={crewData} updateCrewLike={updateCrewLike} />} />
          </Routes>
          <Footer />
      </BrowserRouter>
    </div>
